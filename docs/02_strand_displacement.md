...
## 4. Deterministic Concentrations
...
Therefore computation is inherently kinetic and probabilistic at the level of individual molecular events, that can be used in neural networks.
...
## 4. A Complex Molecular Mechanism Can Produce a Simple Effective Computation
...
## 5. A Released DNA Strand Can Represent an Output Signal
